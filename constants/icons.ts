...
export const IconMap = {
  ...
  sort: { component: MaterialIcons, name: 'sort' },
  ...
  'check-circle': { component: MaterialIcons, name: 'check-circle' },
  cancel: { component: MaterialIcons, name: 'cancel' },
  ...
  trendingDown: { component: Feather, name: 'trending-down' },
